...
sudo scp -r -i ./roles/ec2-launch/mykey.pem centos@$apache1:/tmp/mariadbdump.sql /tmp/

sudo scp -r -i ./roles/ec2-launch/mykey.pem centos@$apache1:/tmp/mariadb_dbresult.txt /tmp/

sudo scp -r -i ./roles/ec2-launch/mykey.pem /tmp/mariadbdump.sql centos@$apache2:/tmp/
